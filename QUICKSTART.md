...
* **Download** the pre-compiled firmware:  [TBD](https://saleshosted.z13.web.core.windows.net/sdk/infineon/TBD) (Right-Click, "Save link as...")
...
* Click **Open** and select the firmware .hex file downloaded (`TBD.hex`)
* Click **Connect**
* Click **Program**
...
* Download the premade  [Device Template](files/psoc6aibm-device-template.json) (Right-click, Save As)
